...
public final class RunParameters implements java.io.Serializable {
    ...
    public static final int IMPL_NTC = 1; // NTC version

    public static final int IMPL_SO = 2; // Shared Object version

    public static final int IMPL_SEQ = 3; // Sequential version

    public static final int IMPL_FULLTREE = 4; // Fulltree version
